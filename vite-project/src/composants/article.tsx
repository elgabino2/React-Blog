...
function Article(){
    return(
        ...
        <div className="h-[8rem] w-[90%]  my-[2rem] mx-[2rem]">
            <h1 className="text-[3rem] font-semibold text-center">What is the real impact of the protection of diversity ?</h1>
        ...
        <div className="h-[30rem] w-[90%] mx-[2rem] my-[6rem] bg-[red] flex justify-center items-center">
            <img src={fox} alt="" className="h-[30rem] w-[100%]"/>
        </div>
        <div className="h-[10rem] w-[90%] my-[-4rem] mx-[2rem]">
            <h1 className="text-[2rem] font-semibold text-center">Introduction</h1>
            <p className="text-[1.3rem] font-serif text-justify">
